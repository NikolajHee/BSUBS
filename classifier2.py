...
for Unique_Compound in tqdm(list_of_compounds):
    ...
    #sensitivity 
    result_basic = permutation_importance(model_basic, X_basic_test, y_test, n_repeats=3, random_state=0)
    ...
    #sensitivity 
    result_semi = permutation_importance(model_semi, X_semi_test, y_test, n_repeats=3, random_state=0)
