...
class decoder(nn.Module):
    def __init__(self, input_dim, latent_dim, channels, hidden_channels, leaky_relu_slope=0.01):
        ...
        self.final = nn.Sequential(
            nn.ConvTranspose2d(in_channels=hidden_channels[-1], out_channels=channels, kernel_size=3, stride=2, padding=7, output_padding=1),
...
class VAE(nn.Module):
    ...
    def decode(self, z):
        mu, log_var =  self.decoder.forward(z)
